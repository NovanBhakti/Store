   <div class="relative isolate px-6 pt-14 lg:px-8" id="first">
       ...
       <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
           <div class="hidden sm:mb-8 sm:flex sm:justify-center">
               <div
                   class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 animate-[bounce_1s_ease-in-out_infinite]">
           ...
           <div class="text-center">
               ...
               @auth
                   @if (Auth::user()->Role == 'member' || Auth::user()->Role == 'admin')
                       <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Hello,
